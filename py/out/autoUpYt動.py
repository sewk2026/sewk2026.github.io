...
- YouTube OAuth secret 放在：/content/drive/MyDrive/山而王其/secret/client_secret.json
...
# -------------- 參數設定（請確認 Drive 路徑） --------------
DRIVE_BASE = '/content/drive/MyDrive/山而王其'
FOLDER_ANIMATION = os.path.join(DRIVE_BASE, '動畫') + '/'     # 主影片與語音
FOLDER_MATERIAL = os.path.join(DRIVE_BASE, '料') + '/'        # start,end,bg
FOLDER_SECRET = os.path.join(DRIVE_BASE, 'secret') + '/'      # 放 client_secret.json
